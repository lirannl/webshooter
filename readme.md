# Webshooter
The goal of Webshooter is to enable remote access to machines using a web browser.
...
- [x] Touchscreen handling - as a native touchscreen, rather than emulating a mouse
